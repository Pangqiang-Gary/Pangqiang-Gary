...
- **Upstream extension** — I name the source project and describe only my delta.
- **Team contribution** — I link merged pull requests or commits instead of presenting team work as solo authorship.
- **Learning / reference** — reproduction, coursework, fine-tuning exercises, or unchanged upstream code.
